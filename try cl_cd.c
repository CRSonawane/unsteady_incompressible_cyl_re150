...
// area weighted average
	...
	{
	  areatot=0.0;
	  for(j=0;j<vertex[i].no_cells;j++)
	  {
		  vertex[i].un[0] = vertex[i].un[0] + cell[vertex[i].cell_list[j]].area*cell[vertex[i].cell_list[j]].u[0];
		  vertex[i].un[1] = vertex[i].un[1] + cell[vertex[i].cell_list[j]].area*cell[vertex[i].cell_list[j]].u[1];
		  vertex[i].un[2] = vertex[i].un[2] + cell[vertex[i].cell_list[j]].area*cell[vertex[i].cell_list[j]].u[2];
		  vertex[i].un[3] = vertex[i].un[3] + cell[vertex[i].cell_list[j]].area*cell[vertex[i].cell_list[j]].u[3];

		  areatot=areatot+cell[vertex[i].cell_list[j]].area;
	  }
	  
	  vertex[i].un[0]=vertex[i].un[0]/areatot;	//vertex[i].no_cells;
	  vertex[i].un[1]=vertex[i].un[1]/areatot;	//vertex[i].no_cells;
	  vertex[i].un[2]=vertex[i].un[2]/areatot;	//vertex[i].no_cells;
	  vertex[i].un[3]=vertex[i].un[3]/areatot;	//vertex[i].no_cells;
...
//lift and drag
	...
	for(i=1;i<=no_edge;i++)
	{
	 	if(edge[i].bc_type == 3 || edge[i].bc_type == 4 || edge[i].bc_type == 5 || edge[i].bc_type == 6 )	//  wall
	  	{
			theta = edge[i].theta * (pi/180.0);
 	    
		      	lift = edge[i].L * (-edge[i].cp*sin(theta) + edge[i].sf*cos(theta) );
	      
		      	drag = edge[i].L * (edge[i].cp*cos(theta) + edge[i].sf*sin(theta) );
